...
EVALMODEL=osamaRbf #Available options are: rbf, neural, knn, armaRbf, osamaRbf, nnc, weightNeural
LOCALMETHOD=none #Available options are: crossover, random, grs, bfgs
NNMETHOD=genetic #Available options are: bfgs, genetic, conj, leve, grs, de
WEIGHTS=10
